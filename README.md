...
### STEP-5: 
Similarly Bob also selects a public key b and computes his secret key as
B and sends the same back to Alice.
### STEP-6: 
Now both of them compute their common secret key as the other
...
## OUTPUT:
![image](https://github.com/user-attachments/assets/732739cf-ec3a-4d1b-a366-8885e9a4687c)
